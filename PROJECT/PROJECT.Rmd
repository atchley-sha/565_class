...
# fillColors <- colorRampPalette(c("red", "lightblue"))(4)
fillColors <- brewer.pal(4, "BuPu") %>% rev()
colorColors <- c("grey60", "black", "yellow")

ggplot(TAZ) +
  geom_sf(aes(fill = ATYPE, color = type), size = 1) +
  theme_void() +
