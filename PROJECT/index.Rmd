...
```{r VCDT, fig.cap="Difference in V/C in Downtown scenario compared to No-Build."}
...
```{r VCNC, fig.cap="Difference in V/C in Neighborhood Centers scenario compared to No-Build."}
...
VMT %>% 
  ...
  # my_kbl(align = 'lccrrrr', caption = "VMT and VHT by Scenario") %>%
  # add_header_above(c(" " = 3, "Difference from No-Build" = 4))
